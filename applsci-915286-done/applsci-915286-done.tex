...
and Ensembl Plants databases. These~datasets were transformed into Linked Data graphs, which include cross-references to many other relevant databases such as Gramene, Plant Reactome, InterPro and KEGG Orthology (KO). %AK: removed , and so forth.
...
we developed %AK: replaced (duplicated) phrase with a verb (past tense)
...
Therefore, QTL information was %AK: verb in past tense
extracted from XML-based %AK: added hyphen
...
we have developed exemplary Jupyter (IPython) Notebooks \cite{Notebooks}. %AK: added ref.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
